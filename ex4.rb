cars = 100                                                                    #cars is a variable name and 100 is assigned to it's value.
space_in_a_car = 4.0                                                          # 4.0 is a floating point value is assigned to a variable name of space_in_a_car.
drivers = 30                                                                   #30 to assign a  drivers
passengers = 90                                                                # 90 to assigned a passengers
cars_not_driven = cars - drivers                                              #subtracted cars-drivers,and the result is(100-30=70).final value is assigned to cars_not_driven  
...
not_available_drivers = 70                                                    #just assigned the value of 70 as not_variable_drivers.
...
# I have  assign variable name with value like not_available_drivers=100, but 18th line i have used variable name as not_available _drivrs.
